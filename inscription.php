...
if ($userid !== $USER->id) {
    print_error('no_permission', 'block_mse_classes', '', $userid);
}

$context = get_context_instance(CONTEXT_COURSE, $courseid);

if (!$course) {
    print_error('no_course', 'block_mse_classes', '', $courseid);
}

$has_permission = true;

if (!$has_permission) {
    print_error('no_permission', 'block_mse_classes');
}

$blockname = get_string('pluginname', 'block_mse_classes');
$header = 'Header';
...
$modules_preselected = $DB->get_records('block_mse_classes_modules');
