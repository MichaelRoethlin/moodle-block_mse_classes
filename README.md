...
and you should find that this mse_classes has been added to the list of
installed modules.
...
[![Build Status](https://travis-ci.org/danielneis/moodle-block_mse_classes.svg?branch=master)](https://travis-ci.org/danielneis/moodle-block_mse_classes)
